    ...
    <div class="indexstats dispatchercharts">
        ...
        <div class="statusbar_Section" id="undelivered_load_bars">
            ...
            <div class="autocomplete"
                style="display: flex;justify-content: space-between;margin-right: 30px;margin-bottom: 30px;">
            ...
            <div style="display: flex;justify-content: space-between;margin-right: 30px;margin-bottom: 30px;">
                <input type="none " onkeyup="search()" style="width: 72%;margin-right: 20px; display: none"
                    type="search" name="search_loadBars" id="search_loadBars" placeholder="search...">
            ...
            <div class="truckNumber" id="truckedit">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="driver_info_form" class="driver_info_form" method="POST"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" name="gdbank" id="gdbank"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="gdno" id="gdno"
